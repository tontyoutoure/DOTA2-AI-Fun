...
function InitUISecond() {
	...
	if (!tFunHeroSelectionOptions.iActivateFunHeroes)
		return;
	$.CreatePanel('Panel', $("#HeroSelectionPanelOld"), "HeroAvatarButtonLineOld1",{id:"HeroAvatarButtonLineOld1", class:"HeroAvatarButtonLine"})
	$.CreatePanel('Panel', $("#HeroSelectionPanelNew"), "HeroAvatarButtonLineNew1",{id:"HeroAvatarButtonLineNew1", class:"HeroAvatarButtonLine"})
	for (var sHeroName in tFunHeroInfo) {
		...
		if (tFunHeroInfo[sHeroName].bOld) {
			$.CreatePanel('Button', $("#HeroAvatarButtonLineOld"+CurrentOldLine.toString()), "HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName,{id:"HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName, class:"HeroAvatarButton", onactivate:"HeroDescription('"+tFunHeroInfo[sHeroName].sCapitalName+"', true);"});
			CurrentOldColumn = CurrentOldColumn+1;
			if(CurrentOldColumn>4){
				CurrentOldColumn=1;
				CurrentOldLine = CurrentOldLine+1;
				$.CreatePanel('Panel', $("#HeroSelectionPanelOld"), "HeroAvatarButtonLineOld"+CurrentOldLine.toString(),{id:"HeroAvatarButtonLineOld"+CurrentOldLine.toString(), class:"HeroAvatarButtonLine"})
			}
		}
		else{
			$.CreatePanel('Button', $("#HeroAvatarButtonLineNew"+CurrentNewLine.toString()), "HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName,{id:"HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName, class:"HeroAvatarButton", onactivate:"HeroDescription('"+tFunHeroInfo[sHeroName].sCapitalName+"', true);"});
			CurrentNewColumn = CurrentNewColumn+1;
			if(CurrentNewColumn>4){
				CurrentNewColumn=1;
				CurrentNewLine = CurrentNewLine+1;
				$.CreatePanel('Panel', $("#HeroSelectionPanelNew"), "HeroAvatarButtonLineNew"+CurrentNewLine.toString(),{id:"HeroAvatarButtonLineNew"+CurrentNewLine.toString(), class:"HeroAvatarButtonLine"})
			}
		}
		...
		$.CreatePanel('Image', $("#HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName), "HeroAvatar"+tFunHeroInfo[sHeroName].sCapitalName,{id:"HeroAvatar"+tFunHeroInfo[sHeroName].sCapitalName, class:"HeroAvatar", src:sAvatarDir})
		$.CreatePanel('Panel', $("#HeroAvatarBtn"+tFunHeroInfo[sHeroName].sCapitalName), "HeroAvatarCover"+tFunHeroInfo[sHeroName].sCapitalName,{id:"HeroAvatarCover"+tFunHeroInfo[sHeroName].sCapitalName, class:"HeroAvatarCover"})
...
function HeroDescriptionInit(sFunHeroName, sHeroName, sHeroNameCapital) {
	...
	var tFunHeroShardInfo = CustomNetTables.GetTableValue("fun_hero_stats", sFunHeroName+"_shard_infos");
	// $.Msg("tFunHeroShardInfo", tFunHeroShardInfo)
	$.CreatePanel('Panel', $("#HeroDescriptionPopPanelContainer"), "HeroDescriptionPopPanel"+sHeroNameCapital,{id:"HeroDescriptionPopPanel"+sHeroNameCapital, class:'HeroDescriptionPopPanel', hittest:'true'})
	var sPanelName = '#HeroDescriptionPopPanel'+sHeroNameCapital
	$.CreatePanel('Panel', $(sPanelName), "HeroNameLine"+sHeroNameCapital,{id:"HeroNameLine"+sHeroNameCapital, class:"HeroNameLine"})
	$.CreatePanel('Label', $("#HeroNameLine"+sHeroNameCapital), "HeroName"+sHeroNameCapital,{id:"HeroName"+sHeroNameCapital, class:"HeroName", text:"#npc_dota_hero_"+sHeroName+"_long"})
	$.CreatePanel('Panel', $("#HeroNameLine"+sHeroNameCapital), "HeroPrimaryAttribute"+sHeroNameCapital,{id:"HeroPrimaryAttribute"+sHeroNameCapital, class:"HeroAttributeContainer"})
	...
	$.CreatePanel('Label', $(sPanelName), "HeroBio"+sHeroNameCapital,{id:"HeroBio"+sHeroNameCapital, class:"HeroBio", text:"#npc_dota_hero_"+sHeroName+"_bio"})
	var aTalents = [];
	if (tFunHeroAbilities) {
		$.CreatePanel('Label', $(sPanelName), '',{class:"HeroAbilityTitle", text:"#DOTA_SHOP_CATEGORY_ABILITIES"})
		$.CreatePanel('Panel', $(sPanelName), "HeroAbilityContainer"+sHeroNameCapital,{id:"HeroAbilityContainer"+sHeroNameCapital, class:"AbilityLine"})
		for (var i = 1; i < 24; i++) {
		...
		//				$("#HeroAbilityContainer"+sHeroNameCapital).BCreateChildren('<DOTAAbilityImage id="Ability'+sHeroNameCapital+i.toString()+'" class="AbilityIcon" abilityname="'+tFunHeroAbilities[i.toString()]+'" onmouseover="DOTAShowAbilityTooltip('+tFunHeroAbilities[i.toString()]+')" onmouseout="DOTAHideAbilityTooltip()"/>')
						$.CreatePanel('Panel', $("#HeroAbilityContainer"+sHeroNameCapital), "AbilityIconContainer"+sHeroNameCapital+i.toString(),{id:"AbilityIconContainer"+sHeroNameCapital+i.toString(), class:"AbilityIconContainer"})
						$.CreatePanel('DOTAAbilityImage', $("#AbilityIconContainer"+sHeroNameCapital+i.toString()), "Ability"+sHeroNameCapital+i.toString(),{id:"Ability"+sHeroNameCapital+i.toString(), class:"AbilityIcon", abilityname:tFunHeroAbilities[i.toString()], onmouseover:"DOTAShowAbilityTooltip("+tFunHeroAbilities[i.toString()]+")", onmouseout:"DOTAHideAbilityTooltip()"})
					}
				}
				else
				{
...
//	$("#HeroAbilityContainer"+sHeroNameCapital).BCreateChildren('<Panel id="Talent'+sHeroNameCapital+'" class="TalentBranch"/>')
	...
	if (tFunHeroScepterInfo || tFunHeroShardInfo){ 
		$.CreatePanel('Panel', $(sPanelName), "HeroScepterInfoContainer"+sHeroNameCapital,{class:"HeroScepterInfoContainer", id:"HeroScepterInfoContainer"+sHeroNameCapital})
		var i = 1
		while (tFunHeroScepterInfo[i.toString()]) {
			$.CreatePanel('Panel', $("#HeroScepterInfoContainer"+sHeroNameCapital), "HeroScepterAbilityContainer"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityContainer", id:"HeroScepterAbilityContainer"+sHeroNameCapital+i.toString()})
			$.CreatePanel('Panel', $("#HeroScepterAbilityContainer"+sHeroNameCapital+i.toString()), "HeroScepterAbilityTitleContainer"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityTitleContainer", id:"HeroScepterAbilityTitleContainer"+sHeroNameCapital+i.toString()})
			
			var sAbilityName = $.Localize("#DOTA_Tooltip_Ability_"+tFunHeroScepterInfo[i.toString()].sAbilityName).toUpperCase()
			$.CreatePanel('Label', $("#HeroScepterAbilityTitleContainer"+sHeroNameCapital+i.toString()), "HeroScepterAbilityTitleUpgrade"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityTitleUpgrade", id:"HeroScepterAbilityTitleUpgrade"+sHeroNameCapital+i.toString(), text:"#scepter_info_title"})
			$.CreatePanel('Label', $("#HeroScepterAbilityTitleContainer"+sHeroNameCapital+i.toString()), "HeroScepterAbilityTitleName"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityTitleName", id:"HeroScepterAbilityTitleName"+sHeroNameCapital+i.toString(), text:sAbilityName})
		...
		while (tFunHeroShardInfo[i.toString()]) {
			$.CreatePanel('Panel', $("#HeroScepterInfoContainer"+sHeroNameCapital), "HeroShardAbilityContainer"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityContainer", id:"HeroShardAbilityContainer"+sHeroNameCapital+i.toString()})
			$.CreatePanel('Panel', $("#HeroShardAbilityContainer"+sHeroNameCapital+i.toString()), "HeroShardAbilityTitleContainer"+sHeroNameCapital+i.toString(),{class:"HeroScepterAbilityTitleContainer", id:"HeroShardAbilityTitleContainer"+sHeroNameCapital+i.toString()})
	...
	if (aTalents.length) {
		$.CreatePanel('Panel', $(sPanelName), "HeroTalentContainer"+sHeroNameCapital,{class:"HeroTalentContainer", id:"HeroTalentContainer"+sHeroNameCapital})
	...
	//	$("#Talent"+sHeroNameCapital).SetPanelEvent("onmouseout", function (){$("#HeroTalentContainer"+sHeroNameCapital).visible=false})
		...
		$.CreatePanel('Label', $("#HeroTalentContainer"+sHeroNameCapital), '',{class:"HeroTalentTitle", text:"#DOTA_AbilityBuild_Talent_Title"})
		var iTalent = 0
		for (var iLevel = 25; iLevel > 5; iLevel=iLevel-5) {
			$.CreatePanel('Panel', $("#HeroTalentContainer"+sHeroNameCapital), "HeroTalentLine"+sHeroNameCapital+iLevel.toString(),{class:"HeroTalentLine", id:"HeroTalentLine"+sHeroNameCapital+iLevel.toString()})
			
			$.CreatePanel('Panel', $("#HeroTalentLine"+sHeroNameCapital+iLevel.toString()), "HeroTalentLeft"+sHeroNameCapital+iLevel.toString(),{class:"HeroTalentLeft", id:"HeroTalentLeft"+sHeroNameCapital+iLevel.toString()})
			$.CreatePanel('Label', $("#HeroTalentLeft"+sHeroNameCapital+iLevel.toString()), "HeroTalentLableLeft"+sHeroNameCapital+iLevel.toString(),{id:"HeroTalentLableLeft"+sHeroNameCapital+iLevel.toString(), class:"HeroTalentContentLabel", text:"#DOTA_Tooltip_ability_"+aTalents[iTalent]})
			...
			iTalent++;			
			$.CreatePanel('Panel', $("#HeroTalentLine"+sHeroNameCapital+iLevel.toString()), "HeroTalentMiddle"+sHeroNameCapital+iLevel.toString(),{class:"HeroTalentMiddle", id:"HeroTalentMiddle"+sHeroNameCapital+iLevel.toString()})
			$.CreatePanel('Label', $("#HeroTalentMiddle"+sHeroNameCapital+iLevel.toString()), '',{class:"HeroTalentReqLabel", text:iLevel.toString()})
			$.CreatePanel('Panel', $("#HeroTalentLine"+sHeroNameCapital+iLevel.toString()), "HeroTalentRight"+sHeroNameCapital+iLevel.toString(),{class:"HeroTalentRight", id:"HeroTalentRight"+sHeroNameCapital+iLevel.toString()})
			
			$.CreatePanel('Label', $("#HeroTalentRight"+sHeroNameCapital+iLevel.toString()), "HeroTalentLableRight"+sHeroNameCapital+iLevel.toString(),{class:"HeroTalentContentLabel", id:"HeroTalentLableRight"+sHeroNameCapital+iLevel.toString(), text:"#DOTA_Tooltip_ability_"+aTalents[iTalent]})
	...
	$.CreatePanel('Button', $(sPanelName), "HeroSelection"+sHeroNameCapital,{id:"HeroSelection"+sHeroNameCapital, class:"HeroSelectionButton", onactivate:"HeroSelection('npc_dota_hero_"+sHeroName+"', '"+sHeroNameCapital+"');"});
	$.CreatePanel('Label', $("#HeroSelection"+sHeroNameCapital), "HeroSelectionLabel",{id:"HeroSelectionLabel", text:"#select_hero"})
	if (sHeroNameCapital == 'Invoker') {
		$.CreatePanel('Button', $(sPanelName), "EnableWearable"+sHeroNameCapital,{id:"EnableWearable"+sHeroNameCapital, class:"HeroSelectionButton", onactivate:"EnableWearable('npc_dota_hero_"+sHeroName+"', '"+sHeroNameCapital+"');", onmouseover:"DOTAShowTextTooltip(#InvokerRetroChangeWearable_enable_tooltip)", onmouseout:"DOTAHideTextTooltip()"});
		$.CreatePanel('Label', $("#EnableWearable"+sHeroNameCapital), '',{text:"#InvokerRetroChangeWearable_enable"})
		$("#EnableWearable"+sHeroNameCapital).visible = true
		$.CreatePanel('Button', $(sPanelName), "DisableWearable"+sHeroNameCapital,{id:"DisableWearable"+sHeroNameCapital, class:"HeroUnselectionButton", onactivate:"DisableWearable('npc_dota_hero_"+sHeroName+"', '"+sHeroNameCapital+"');"});
		$.CreatePanel('Label', $("#DisableWearable"+sHeroNameCapital), '',{text:"#InvokerRetroChangeWearable_disable" })
	}
}
