...
var tFunHeroInfo = {
	...
	'troll_warlord':{'sName':'worst_stats_hero', 'sCapitalName':'TrollWarlord', 'bNewAvatar':false, 'bOld':false, 'bImba':true,'bDeveloping':false},
	'monkey_king':{'sName':'best_stats_hero', 'sCapitalName':'MonkeyKing', 'bNewAvatar':false, 'bOld':false, 'bImba':true,'bDeveloping':false},
	'batrider':{'sName':'kahmeka', 'sCapitalName':'Batrider', 'bNewAvatar':false, 'bOld':true, 'bImba':false},
	'storm_spirit':{'sName':'old_storm_spirit', 'sCapitalName':'StormSpirit', 'bNewAvatar':false, 'bOld':true, 'bImba':false},
	'medusa':{'sName':'old_gorgon', 'sCapitalName':'Medusa', 'bNewAvatar':false, 'bOld':true, 'bImba':false,'bDeveloping':false},
	'furion':{'sName':'god_of_wind', 'sCapitalName':'Furion', 'bNewAvatar':true, 'bOld':true, 'bImba':false,'bDeveloping':true},
}
