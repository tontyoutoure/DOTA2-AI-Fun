...
LuaConsole.OnAddTestItemsActive = function () {
	...
	LuaConsole.OnInputSubmitted();
	$("#CommandEntry").text = "SendToServerConsole(\"dota_bot_give_item item_ultimate_scepter\")";
	LuaConsole.OnInputSubmitted();
	$("#CommandEntry").text = "";
}
...
LuaConsole.OnAddTestHeroesActive = function () {
	$("#CommandEntry").text = "SendToServerConsole(\"dota_create_unit npc_dota_hero_rubick enemy\")";
	LuaConsole.OnInputSubmitted();
	$("#CommandEntry").text = "SendToServerConsole(\"dota_create_unit npc_dota_hero_morphling enemy\")";
	LuaConsole.OnInputSubmitted();
	$("#CommandEntry").text = "";
}

LuaConsole.OnWinGame = function () {
	 $("#CommandEntry").text = "GameRules:SetGameWinner(DOTA_TEAM_GOODGUYS)";
	 $("#CommandEntry").SetFocus();
	 $("#CommandEntry").SetCursorOffset(43);
}
