...
function Precache( context )
	...
	PrecacheResource("particle","particles/econ/items/wisp/wisp_relocate_channel_ti7.vpcf", context)
	PrecacheResource("particle","particles/econ/items/wisp/wisp_relocate_marker_ti7_endpoint.vpcf", context)
	...
	PrecacheResource("particle", "particles/gambler_base_attack.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_arcane_arts.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_betrayal.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_deafening_blast_debuff.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_deafening_blast_impact.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_disarm_impact.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_energy_ball.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_energy_ball_discharge.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_firebolt.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_firestorm_fireball.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_frost_nova.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_incinerate.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_inferno.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_invisibility_aura.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_lightning_shield.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_lightning_shield_arc.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_mana_burn.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_portal.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_power_word_ally.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_power_word_enemy.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_shock_lightning_bolt.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_shock_ground.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_shock_base_attack_explosion.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_shock_sparks.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_shroud_of_flames.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_soul_reaver_damage_delayed.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_soul_reaver_damage_initial_glow.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_soul_reaver_movement_speed_boost_begin.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_retro_soul_reaver_movement_speed_boost_modifier.vpcf", context)
	...
	PrecacheResource("soundfile", "soundevents/retro_dota.vsndevts", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_alchemist.vsndevts", context)
	PrecacheResource("particle", "particles/econ/items/skywrath_mage/skywrath_ti9_immortal_back/skywrath_mage_ti9_arcane_bolt.vpcf", context)
