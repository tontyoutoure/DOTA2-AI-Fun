...
modifier_bastion_transference_agi = class({})
modifier_bastion_transference_int = class({})
modifier_bastion_transference_str = class({})

modifier_bastion_transference_agi.DeclareFunctions = function(self)	return {MODIFIER_PROPERTY_STATS_AGILITY_BONUS} end
function modifier_bastion_transference_agi.GetModifierBonusStats_Agility() return self:GetStackCount() end

modifier_bastion_transference_int.DeclareFunctions = function(self)	return {MODIFIER_PROPERTY_STATS_INTELLECT_BONUS} end
function modifier_bastion_transference_int.GetModifierBonusStats_Intellect() return self:GetStackCount() end

modifier_bastion_transference_agi.DeclareFunctions = function(self)	return {MODIFIER_PROPERTY_STATS_STRENGTH_BONUS} end
function modifier_bastion_transference_agi.GetModifierBonusStats_Strength() return self:GetStackCount() end