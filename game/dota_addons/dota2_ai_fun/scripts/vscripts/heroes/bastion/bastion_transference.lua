...
LinkLuaModifier("modifier_bastion_transference_agi", "heroes/bastion/bastion_modifiers.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bastion_transference_int", "heroes/bastion/bastion_modifiers.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bastion_transference_str", "heroes/bastion/bastion_modifiers.lua", LUA_MODIFIER_MOTION_NONE)
