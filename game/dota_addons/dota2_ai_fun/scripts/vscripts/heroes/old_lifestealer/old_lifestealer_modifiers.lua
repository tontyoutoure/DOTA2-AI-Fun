...
function modifier_old_lifestealer_feast:DeclareFunctions() return {MODIFIER_EVENT_ON_ATTACK_LANDED} end
function modifier_old_lifestealer_feast:OnAttackLanded(keys)
	if keys.attacker ~= self:GetParent() then return end
	if keys.attacker:PassivesDisabled() or keys.attacker:GetTeam() == keys.target:GetTeam() or keys.target:IsBuilding() then return end
