...
modifier_magic_dragon_dragon_magic_lua = class({})
function modifier_magic_dragon_dragon_magic_lua:IsHidden() return true end
function modifier_magic_dragon_dragon_magic_lua:RemoveOnDeath() return false end
function modifier_magic_dragon_dragon_magic_lua:IsPurgable() return false end

function modifier_magic_dragon_dragon_magic_lua:CheckState() if self:GetParent():HasScepter() then return {[MODIFIER_STATE_FLYING]=true} else return {} end end
function modifier_magic_dragon_dragon_magic_lua:OnCreated() self:StartIntervalThink(FrameTime()) end 
function modifier_magic_dragon_dragon_magic_lua:OnIntervalThink() 
	if IsClient() then return end
