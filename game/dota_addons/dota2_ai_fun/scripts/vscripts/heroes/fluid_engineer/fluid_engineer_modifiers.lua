...
function modifier_fluid_engineer_bowel_hydraulics:CheckState() if self:GetCaster():HasScepter() then return {[MODIFIER_STATE_MUTED] = true, [MODIFIER_STATE_SILENCED] = true} else return {} end end
